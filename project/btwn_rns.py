...
def between_runs(writer, between_run, test_item, column_names):
    """
    ...
    between_run = between_run.groupby([column_names['id'][0], "Nominal conc. [ng/mL]",]).agg({
            "Accuracy [%]": ["mean",],
    ...
    # Format headers, column_names['name'][0] is not needed, as this is uniform
