...
def test_command_args():
    ...
    with patch.object(sys, "argv", testargs_again):
        ...
        assert args_again.testitem == "ibuprofen"
        assert args_again.output == "Bioanalytical_results.xlsx"


def test_get_sheets():
    assert get_sheets("TEST_DATA01.xlsx") == [
        "RD R01",
        "RD R02",
        "RD R03",
        "RD R04",
    ]
    assert get_sheets("TEST_DATA02.xlsx") == [
        "RD R01",
        "RD R02",
        "RD R03",
        "RD R04",
...
def test_get_data():
    ...
    assert get_data("test_data.txt")["day"] == [
        "Day 1",
        "Day 2",
        "Day 3",
        "Day 100",
    ...
    assert get_data("test_data.txt")["group"] == [
        "Group 1 male",
        "G 1 F",
        "GROUPE2 male",
        "Group2F",
    ...
    assert get_data("test_data.txt")["time"] == [
        "0h",
        "0.5h",
        "1h",
        "2h",
    ...
    assert get_data("test_data.txt")["additional_data"] == [
        "data01",
        "2nd_data",
        "data_the_3rd",
    ]
